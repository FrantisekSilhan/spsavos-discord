...
export const DiscordBots = pgTable('DiscordBots', {
    id: smallserial('id').primaryKey(),
    api_key: text('api_key').notNull().unique()
});

export const DiscordBotConfigs = pgTable('DiscordBotConfigs', {
    id: smallserial('id').primaryKey(),
...
export const DiscordCounters = pgTable('DiscordCounters', {
